...
@export var ending_fade_texture: Texture2D = preload("res://assets/ski/skifield.png")
...
func prepare(scene_key: String) -> void:
	if scene_key == "ending":
		_next_fade_texture = ending_fade_texture
		return
	_next_fade_texture = null
